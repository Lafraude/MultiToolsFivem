...
<body>
    ...
    <div>
        <nav id="navbar" class="navbar">
            ...
            <ul>
                ...
                <button class="btnnav" onclick="executeOption('optionviergepack')">Reset Pack</button>
                <h6 class="messmodscontient">L'option Reset Pack vous remettra un citizen vierge et un dossier mods vierge</h6>
    ...
    <div id="packgunfightfivemid" class="packgunfight">
        ...
        <div class="packavecmods" data-id="packgunfight-option8">
            <h4>Snowfall</h4>
            <img class="zoomable" src="package/packfivemgf/snowfall/snowfall.png" alt="">
            <button class="btn" onclick="executeOption('optiongf8')">Activer le pack</button>
            <!-- <button class="btnF">Ajouter en favori</button> -->
            <h6 class="messmodscontient">Attention, ce pack contient des mods suite à l'ajout du pack tous vos anciens mods vont être supprimés</h6>
        </div>
        <div data-id="packgunfight-option9">
            <h4>Bleu FPS</h4>
            <img class="zoomable" src="package/packfivemgf/bleufps/bleufps.png" alt="">
            <button class="btn" onclick="executeOption('optiongf9')">Activer le pack</button>
            <!-- <button class="btnF">Ajouter en favori</button> -->
            <h6>Source : .gg/EWKPJ7YAZF</h6>
        </div>
    </div>
    ...
    const particles = [];
    const colors = ["#ffffff", "#3b82f6", "#1e3a8a"];
    ...
    class Particle {
        constructor(x, y) {
            ...
            this.size = Math.random() * 1 + 0.2; // Micro particule
            this.color = colors[Math.floor(Math.random() * colors.length)];
            this.speedX = Math.random() * 0.2 - 0.1; // Déplacement très lent
    ...
    function initParticles() {
        particles.length = 0; 
        const particleCount = 500; // + de particules
...
class Api:
    ...
    def spoofer_declenchement(self):
        ...
        toaster.show_toast("FIVPACK", "✅ Confirmation, vous avez été spoof avec succès", icon_path=icon_path, duration=5)

    def add_pack(self):
        toaster.show_toast("FIVPACK", "✅ Confirmation, votre pack a été ajouté avec succès", icon_path=icon_path, duration=5)

    def clear_cache(self):
        supprimer_cache()
        toaster.show_toast("FIVPACK", "✅ Confirmation, votre cache a été delete avec succès", icon_path=icon_path, duration=5)

    def clear_mods(self):
        startclearmods()  
        toaster.show_toast("FIVPACK", "✅ Confirmation, votre dossier mods a été delete avec succès", icon_path=icon_path, duration=5)
...
def run_app():
    api = Api()
    webview.create_window("FIVPACK", html_file_path, js_api=api)
    webview.start()
